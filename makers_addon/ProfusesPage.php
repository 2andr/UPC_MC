				...
				<tr>
						<th scope='col' id='cb' class='manage-column column-cb check-column'  style="">
								<input type="checkbox" /></th><th scope='col' id='field-name' class='manage-column column-name sortable desc'  style="">
										<?php if ($_GET['OrderBy'] == "Profuse_Name" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=UPCP-options&DisplayPage=Profuses&OrderBy=Profuse_Name&Order=DESC'>";}
											  ...
											  <span><?php _e("Profuse Name", 'ultimate-product-catalogue') ?></span>
						...
						<th scope='col' id='description' class='manage-column column-description sortable desc'  style="">
									  <?php if ($_GET['OrderBy'] == "Profuse_Slug" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=UPCP-options&DisplayPage=Profuses&OrderBy=Profuse_Slug&Order=DESC'>";}
											  ...
											  <span><?php _e("Profuse Slug", 'ultimate-product-catalogue') ?></span>
												<span class="sorting-indicator"></span>
										</a>
						</th>
						<th scope='col' id='description' class='manage-column column-description sortable desc'  style="">
		 ...
		 <?php
				if ($myrows) {
	  			  foreach ($myrows as $Profuse) {
								...
								echo "<a class='delete-tag' href='admin.php?page=UPCP-options&Action=UPCP_DeleteProfuse&DisplayPage=Profuses&Profuse_ID=" . $Profuse->Profuse_ID ."'>" . __("Delete", 'ultimate-product-catalogue') . "</a>";
		 						echo "</span>";
								echo "</div>";
...
<div class="form-wrap">
<h2><?php _e("Add New Profuse", 'ultimate-product-catalogue') ?></h2>
...
<div class="form-field form-required">
	<label for="Profuse_Name"><?php _e("Name", 'ultimate-product-catalogue') ?></label>
...
<div class="form-field form-required">
	<label for="Profuse_Slug"><?php _e("Slug", 'ultimate-product-catalogue') ?></label>
...
<div class="form-field">
	<label for="Profuse_Description"><?php _e("Description", 'ultimate-product-catalogue') ?></label>
...
<div class="form-field">
	<label for="Profuse_Image"><?php _e("Image", 'ultimate-product-catalogue') ?></label>
	...
	<p><?php _e("An image that will be displayed in association with this Profuse, if that option is selected in the 'Options' tab. Current Image:", 'ultimate-product-catalogue') ?><br/><img class="PreviewImage" height="100" width="100" src="<?php echo $Profuse->Profuse_Image;?>" /></p>
	<div class='clear'></div>
</div>
