...
function Update_UPCP_Content() {
	...
	if (isset($_GET['Action'])) {
		switch ($_GET['Action']) {
			...
			case "UPCP_EditMaker":
			case "UPCP_AddMaker":
					$upcp_message = Add_Edit_Maker();
					break;
			case "UPCP_DeleteMaker":
					$upcp_message = Delete_UPCP_Maker($_GET['Maker_ID']);
					break;
			case "UPCP_MassDeleteMakers":
					$upcp_message = Mass_Delete_UPCP_Makers();
					break;		
			case "UPCP_EditProfuse":
			case "UPCP_AddProfuse":
					$upcp_message = Add_Edit_Profuse();
					break;
			case "UPCP_DeleteProfuse":
					$upcp_message = Delete_UPCP_Profuse($_GET['Profuse_ID']);
					break;
			case "UPCP_MassDeleteProfuses":
					$upcp_message = Mass_Delete_UPCP_Profuses();
					break;		
