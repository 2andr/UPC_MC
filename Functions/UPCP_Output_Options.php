...
function UPCP_Output_Options() {
	...
	global $categories_table_name, $subcategories_table_name, $items_table_name, $item_images_table_name, $item_videos_table_name, $catalogues_table_name, $catalogue_items_table_name, $tagged_items_table_name, $tags_table_name, $tag_groups_table_name, $fields_table_name, $fields_meta_table_name, $makers_table_name, $makers_meta_table_name, $profuses_table_name, $profuses_meta_table_name;
	...
	if ($_GET['Action'] == "UPCP_Item_Details" or
		...
		$_GET['Action'] == "UPCP_Maker_Details" or
		$_GET['Action'] == "UPCP_Profuse_Details" or
