...
function Initial_UPCP_Options() {
	...
	if (get_option("UPCP_Sidebar_Items_Order") == "") {update_option("UPCP_Sidebar_Items_Order", array("Product Sort", "Product Search", "Price Filter", "Categories", "Sub-Categories", "Tags", "Custom Fields", "Makers"));}
