...
$makers_table_name = $wpdb->prefix . "UPCP_Makers";
$makers_meta_table_name = $wpdb->prefix . "UPCP_Makers_Meta";
$profuses_table_name = $wpdb->prefix . "UPCP_Profuses";
$profuses_meta_table_name = $wpdb->prefix . "UPCP_Profuses_Meta";
$UPCP_db_version = "4.4.7a_2";
...
function UPCP_Plugin_Menu() {
	...
	add_submenu_page('UPCP-options', 'Makers', 'Makers', $Access_Role, 'UPCP-options&DisplayPage=Makers', 'UPCP_Output_Options');
	add_submenu_page('UPCP-options', 'Profuses', 'Profuses', $Access_Role, 'UPCP-options&DisplayPage=Profuses', 'UPCP_Output_Options');
