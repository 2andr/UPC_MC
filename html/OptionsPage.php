...
<table id='catalogue-page-display-options-table' class="form-table upcp-options-table">
	...
	<tr>
	<th scope="row"><?php _e("Display Makers in Thumbnails", 'ultimate-product-catalogue')?> <br/>
	</th>
	<td>
		<fieldset>
			<div class="ewd-upcp-admin-hide-radios">
				<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='display_makers_in_thumbnails' value='Yes' <?php if($Display_Makers_In_Thumbnails == "Yes") {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
				<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='display_makers_in_thumbnails' value='No' <?php if($Display_Makers_In_Thumbnails == "No") {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
			</div>
			<label class="ewd-upcp-admin-switch">
			...
			<p><?php _e("Should the makers associated with a product be displayed in the product listing on the catalog page?", 'ultimate-product-catalogue')?></p>
		</fieldset>
	</td>
	</tr>
	
	<tr>
	<th scope="row"><?php _e("Display Profuses in Thumbnails", 'ultimate-product-catalogue')?> <br/>
	</th>
	<td>
		<fieldset>
			<div class="ewd-upcp-admin-hide-radios">
				<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='display_profuses_in_thumbnails' value='Yes' <?php if($Display_Profuses_In_Thumbnails == "Yes") {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
				<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='display_profuses_in_thumbnails' value='No' <?php if($Display_Profuses_In_Thumbnails == "No") {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
			</div>
			<label class="ewd-upcp-admin-switch">
			...
			<p><?php _e("Should the profuses associated with a product be displayed in the product listing on the catalog page?", 'ultimate-product-catalogue')?></p>
		</fieldset>
	</td>
	</tr>
</table>
...
<table id='product-page-options-table' class="form-table upcp-options-table">
	...
	<td>
		...
		<label title='Makers' class='ewd-upcp-admin-input-container'><input type='checkbox' name='extra_elements[]' value='Makers' <?php if(in_array("Makers", $Extra_Elements)) {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-checkbox'></span> <span><?php _e("Makers", 'ultimate-product-catalogue')?></span></label><br />
		
		<label title='Profuses' class='ewd-upcp-admin-input-container'><input type='checkbox' name='extra_elements[]' value='Profuses' <?php if(in_array("Profuses", $Extra_Elements)) {echo "checked='checked'";} ?> /><span class='ewd-upcp-admin-checkbox'></span> <span><?php _e("Profuses", 'ultimate-product-catalogue')?></span></label><br />
...
<div id='Premium' class='upcp-option-set<?php echo ( $Display_Tab == 'Premium' ? '' : ' upcp-hidden' ); ?>'>
	...
	<table id='premium-options-features' class="form-table upcp-options-table<?php echo ( ( $Full_Version != 'Yes' or get_option('UPCP_Trial_Happening') == 'Yes' ) ? ' ewd-upcp-premium-options-table' : '' ); ?>">
		...
		<tr>
			<th scope="row"><?php _e("Hide Blank Makers", 'ultimate-product-catalogue')?> <br/>
			</th>
			<td>
				<fieldset><legend class="screen-reader-text"><span><?php _e("Should makers be hidden when they are empty?", 'ultimate-product-catalogue')?></span></legend>
					<div class="ewd-upcp-admin-hide-radios">
						<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='makers_blank' value='Yes' <?php if($Makers_Blank == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
						<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='makers_blank' value='No' <?php if($Makers_Blank == "No") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
					</div>
					<label class="ewd-upcp-admin-switch">
					...
					<p><?php _e("Should Makers be hidden when they are empty?", 'ultimate-product-catalogue')?></p>
				</fieldset>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e("Hide Blank Profuses", 'ultimate-product-catalogue')?> <br/>
			</th>
			<td>
				<fieldset><legend class="screen-reader-text"><span><?php _e("Should profuses be hidden when they are empty?", 'ultimate-product-catalogue')?></span></legend>
					<div class="ewd-upcp-admin-hide-radios">
						<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='profuses_blank' value='Yes' <?php if($Profuses_Blank == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
						<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='profuses_blank' value='No' <?php if($Profuses_Blank == "No") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
					</div>
					<label class="ewd-upcp-admin-switch">
					...
					<p><?php _e("Should Profuses be hidden when they are empty?", 'ultimate-product-catalogue')?></p>
				</fieldset>
			</td>
		</tr>
		<tr>
			<th scope="row"><?php _e("Maker Slugs Conversion", 'ultimate-product-catalogue')?> <br/>
			</th>
			<td>
				<fieldset><legend class="screen-reader-text"><span><?php _e("Are maker slugs being used in the product descriptions?", 'ultimate-product-catalogue')?></span></legend>
					<div class="ewd-upcp-admin-hide-radios">
						<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='maker_converion' value='Yes' <?php if($Maker_Conversion == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
						<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='maker_converion' value='No' <?php if($Maker_Conversion == "No") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
					</div>
					<label class="ewd-upcp-admin-switch">
					...
					<p><?php _e("Are maker slugs being used in the product descriptions?", 'ultimate-product-catalogue')?></p>
				</fieldset>
			</td>
		</tr>
		
		<tr>
			<th scope="row"><?php _e("Profuse Slugs Conversion", 'ultimate-product-catalogue')?> <br/>
			</th>
			<td>
				<fieldset><legend class="screen-reader-text"><span><?php _e("Are profuse slugs being used in the product descriptions?", 'ultimate-product-catalogue')?></span></legend>
					<div class="ewd-upcp-admin-hide-radios">
						<label title='Yes' class='ewd-upcp-admin-input-container'><input type='radio' name='profuse_converion' value='Yes' <?php if($Profuse_Conversion == "Yes") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("Yes", 'ultimate-product-catalogue')?></span></label><br />
						<label title='No' class='ewd-upcp-admin-input-container'><input type='radio' name='profuse_converion' value='No' <?php if($Profuse_Conversion == "No") {echo "checked='checked'";} ?> <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/><span class='ewd-upcp-admin-radio-button'></span> <span><?php _e("No", 'ultimate-product-catalogue')?></span></label><br />
					</div>
					<label class="ewd-upcp-admin-switch">
					...
					<p><?php _e("Are profuse slugs being used in the product descriptions?", 'ultimate-product-catalogue')?></p>
				</fieldset>
			</td>
		</tr>
	...
	<div class="ewd-upcp-admin-styling-section">
		<div class="ewd-upcp-admin-styling-subsection">
			...
			<div class="ewd-admin-labelling-section">
				...
				<label>
					<p><?php _e("Makers Label", 'ultimate-product-catalogue')?></p>
					<input type='text' name='makers_label' value='<?php echo $Makers_Label; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/>
				</label>
				<label>
					<p><?php _e("Profuses Label", 'ultimate-product-catalogue')?></p>
	...
	<div class="ewd-upcp-admin-styling-section">
		<div class="ewd-upcp-admin-styling-subsection">
			...
			<div class="ewd-admin-labelling-section">
				...
				<label>
					<p><?php _e("MakersCard Label", 'ultimate-product-catalogue')?></p>				
					<input type='text' name='makersCard_label' value='<?php echo $MakersCard_Label; ?>' <?php if ($Full_Version != "Yes") {echo "disabled";} ?>/>
				</label>
				<label>
					<p><?php _e("ProfusesCard Label", 'ultimate-product-catalogue')?></p>				
