				...
				<tr>
						...
						<th scope='col' id='requirements' class='manage-column column-requirements sortable desc'  style="">
									  <?php if ($_GET['OrderBy'] == "Maker_Item_Count" and $_GET['Order'] == "ASC") { echo "<a href='admin.php?page=UPCP-options&DisplayPage=Makers&OrderBy=Maker_Item_Count&Order=DESC'>";}
											  ...
											  <span><?php _e("Products in Maker", 'UPC_MC') ?></span>
												<span class="sorting-indicator"></span>
										</a>
						</th>
				</tr>
...
<div class="form-wrap">
<h3><?php _e("Add a New Maker", 'UPC_MC') ?></h3>
...
<div class="form-field form-required">
	...
	<p><?php _e("The name of the maker for your own purposes.", 'UPC_MC') ?></p>
</div>
<div class="form-field form-required">
...
<div class="form-field form-required">
	...
	<p><?php _e("Longtitude of maker address.", 'UPC_MC') ?></p>
</div>
<div class="form-field">
	...
	<p><?php _e("The description of the maker. What will it be used to display?", 'UPC_MC') ?></p>
</div>
<div class="form-field">
