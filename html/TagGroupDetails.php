		...
		<div class="OptionTab ActiveTab" id="EditTag">
			<div id="col-right">
				<div class="col-wrap">
					...
					<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span><?php _e("Tags in Tag Group", 'UPC_MC') ?></span></h3>
						<div class="inside">
		...
		<div class="form-wrap TagGroupDetail">
			...
			<input type="hidden" name="Tag_Group_ID" value="<?php echo $Tag_Group->Tag_Group_ID; ?>" />
 			...
 			<div class='form-field'>
				<label for="Tag_Group_Name"><?php _e("Tag Group Name", 'UPC_MC') ?></label>
				<input name="Tag_Group_Name" id="Tag_Group_Name" type="text" value="<?php echo $Tag_Group->Tag_Group_Name;?>" size="60" />
				<p><?php _e("The name of the group of tags that have similar properties.", 'UPC_MC') ?></p>
			</div>

			<div class='form-field'>
				<label for="Tag_Group_Description"><?php _e("Description", 'UPC_MC') ?></label>
				...
				<p><?php _e("The description of the tag group. What tags should be included in this group?", 'UPC_MC') ?></p>
 			</div>
