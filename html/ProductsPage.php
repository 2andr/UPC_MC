...
<div class="form-field">
	...
	<option value=""></option>
	<?php $SubCategories = $wpdb->get_results("SELECT * FROM $subcategories_table_name ORDER BY SubCategory_Name");
						foreach ($SubCategories as $SubCategory) {
...
<?php include UPCP_CD_PLUGIN_PATH . 'makers_addon/ProductPage_Makers.php'; ?>
